...
public final class ErrorCode {
	...
	public static final String ERROR_TC_NOT_YET_ACCEPTED				= MODULE_ID + "000008";
	public static final String ERROR_SAVE_CARD_NOT_ACTIVE				= MODULE_ID + "000009";
	public static final String ERROR_GENERIC_CALLING_PM_WALLET_SERVICE	= MODULE_ID + "00000A";
